...
namespace GestEase.Migrations
{
    ...
    [Migration("20250503180307_AddUtilisateurIdToCommandeFournisseur")]
    partial class AddUtilisateurIdToCommandeFournisseur
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestEase.Models.CommandeClient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("commandes_clients");
                });

            modelBuilder.Entity("GestEase.Models.CommandeFournisseur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("commandes_fournisseurs");
                });
            ...
            modelBuilder.Entity("GestEase.Models.Utilisateur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GestEase.Models.ArticleCommande", b =>
                {
                    b.HasOne("GestEase.Models.CommandeFournisseur", "Commande")
                        .WithMany()
            ...
            modelBuilder.Entity("GestEase.Models.CommandeFournisseur", b =>
                {
                    ...
                    b.HasOne("GestEase.Models.Utilisateur", "Utilisateur")
                        .WithMany()
